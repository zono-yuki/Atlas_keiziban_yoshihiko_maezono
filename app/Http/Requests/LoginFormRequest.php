...
class LoginFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'email' => 'required|string|min:11|max:40|email',

            'password' => 'required|regex:/^[a-zA-Z0-9]+$/|min:1|max:10',
        ];
    }
    ...
    public function messages() //エラーメッセージ
    {
        return [
            ...
            'email.max' => '※メールアドレスは40文字以下で入力して下さい。',
            ...
            'password.max' => '※パスワードは10文字以下で入力して下さい。',
        ];
    }
}
